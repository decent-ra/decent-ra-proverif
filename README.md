...
* `DecentRaLib.pvl` -- this is the source of prove code where we define the behavior of Decent protocol, including the crypto algorithms we are using.
* `vf-<index>-<scenario>-<property>.py` -- these are the sources of prove code where we define the scenario and queries.
